...
namespace POYA.Controllers
{
    public class EduHubArticlesController : Controller
    {
        ...
        // GET: EduHubArticles/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: EduHubArticles/Create
