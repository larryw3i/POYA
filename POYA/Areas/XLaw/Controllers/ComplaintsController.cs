...
namespace POYA.Areas.XLaw.Controllers
{
    ...
    public class ComplaintsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ToId,AdminId,IsIllegal,Comment")] Complaint complaint)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ToId,AdminId,IsIllegal,Comment")] Complaint complaint)
        {
            if (id != complaint.Id)
            {
                return NotFound();
